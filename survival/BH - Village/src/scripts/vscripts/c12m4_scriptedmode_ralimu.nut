...
function OnScriptEvent_ralimu_survival_post_entity(params)
{
	...
	*/
	...
	make_ladder( ADDON_PREFIX+"_ladders" , VSSM_2.ToKVString(), Vector(2916, 4642, -681).ToKVString(), "0 0 0", "1 0 0", 0)
	make_ladder( ADDON_PREFIX+"_ladders" , VSSM_3.ToKVString(), Vector(3212, 5005, -498).ToKVString(), "0 0 0", "1 0 0", 0)
